...
import 'zz_box_shadow.dart';

/// 和 [ZzBoxShadow] 配套使用，实现内阴影
class ZzBoxDecoration extends painting.BoxDecoration {
  const ZzBoxDecoration({
    Color? color,
    DecorationImage? image,
    BoxBorder? border,
    BorderRadiusGeometry? borderRadius,
    List<ZzBoxShadow>? boxShadow,
    Gradient? gradient,
  ...
  ZzBoxDecoration copyWith({
    ...
    assert(boxShadow is List<ZzBoxShadow>?);

    return ZzBoxDecoration(
      color: color ?? this.color,
      image: image ?? this.image,
      border: border ?? this.border,
      borderRadius: borderRadius ?? this.borderRadius,
      boxShadow: (boxShadow ?? this.boxShadow) as List<ZzBoxShadow>?,
  ...
  @override
  ZzBoxDecoration scale(double factor) {
    return ZzBoxDecoration(
      ...
      boxShadow:
          ZzBoxShadow.lerpList(null, boxShadow as List<ZzBoxShadow>, factor),
  ...
  @override
  ZzBoxDecoration? lerpFrom(Decoration? a, double t) {
    if (a == null) return scale(t);
    if (a is ZzBoxDecoration) return ZzBoxDecoration.lerp(a, this, t);
    return super.lerpFrom(a, t) as ZzBoxDecoration?;
  }

  @override
  ZzBoxDecoration? lerpTo(Decoration? b, double t) {
    if (b == null) return scale(1.0 - t);
    if (b is ZzBoxDecoration) return ZzBoxDecoration.lerp(this, b, t);
    return super.lerpTo(b, t) as ZzBoxDecoration?;
  }
  ...
  static ZzBoxDecoration? lerp(
      ZzBoxDecoration? a, ZzBoxDecoration? b, double t) {
    if (a == null && b == null) {
      return null;
    }
    if (a == null) {
    ...
    return ZzBoxDecoration(
      ...
      boxShadow: ZzBoxShadow.lerpList(a.boxShadow as List<ZzBoxShadow>,
          b.boxShadow as List<ZzBoxShadow>, t),
...
class _InsetBoxDecorationPainter extends BoxPainter {
  ...
  final ZzBoxDecoration _decoration;
  ...
  void _paintInnerShadows(
    ...
    for (final painting.BoxShadow boxShadow in _decoration.boxShadow!) {
      ...
      if (boxShadow is! ZzBoxShadow || !boxShadow.inset) {
        continue;
      }
...
Rect _areaCastingShadowInHole(Rect holeRect, ZzBoxShadow shadow) {
  var bounds = holeRect;
